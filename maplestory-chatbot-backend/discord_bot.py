...
async def help_command(ctx):
    ...
    embed.add_field(
        ...
        value=(
            "**🎉 이벤트 관련:**\n"
            "• !질문 여름 이벤트 보상 목록과 참여 방법을 정리해줘\n"
            "• !질문 제네시스 패스 구매 혜택을 알려줘\n"
            "**⚔️ 렌 직업 관련:**\n"
            "• !질문 렌 260레벨 최단 육성 루트를 알려줘\n"
            "• !질문 렌의 주력기 스킬 정보를 알려줘\n"
            "**🏆 챌린저스 서버:**\n"
            "• !질문 챌린저스 서버에서 시작하는 뉴비인데 직업을 추천해줘\n"
            "• !질문 챌린저스 서버에서 매일 해야하는 것들을 알려줘"
        ),
        inline=False
    )
